...
local function Notify(titulo, texto, duracao)
    ...
    task.spawn(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            ...
            Text = texto,
            Duration = duracao,
            Icon = "rbxassetid://92760392968513"
        })
    end)
end
...
Logo.Image = "rbxassetid://92760392968513" -- LOGO DEAL BLOX CORRETA
...
local GuiConfig = {
    ...
    Cores = {
        Primaria = Color3.fromRGB(46, 99, 184),
        Secundaria = Color3.fromRGB(184, 46, 46),
        Fundo = Color3.fromRGB(10, 10, 15),
        FundoTransparente = 0.08,
        Borda = Color3.fromRGB(184, 46, 46),
        Texto = Color3.fromRGB(255, 255, 255),
        AbaAtiva = Color3.fromRGB(46, 99, 184),
        AbaInativa = Color3.fromRGB(20, 28, 40),
        BotaoAtivo = Color3.fromRGB(46, 99, 184)
    }
}
...
local function CreateMainGui()
    ...
    OpenButton.Image = "rbxassetid://92760392968513"
    ...
    BtnText.ZIndex = 1001
    BtnText.InputTransparent = true


    local BtnTextStroke = Instance.new("UIStroke")
    BtnTextStroke.Color = Color3.fromRGB(0, 0, 0)
    BtnTextStroke.Thickness = 2
    BtnTextStroke.Parent = BtnText

    -- Se a imagem carregar, esconde o texto
    pcall(function()
        OpenButton:GetPropertyChangedSignal("IsLoaded"):Connect(function()
            if OpenButton.IsLoaded then
    ...
    BubbleGlow.Parent = OpenButton
    BubbleGlow.BackgroundTransparency = 1
    BubbleGlow.Size = UDim2.new(1, 30, 1, 30)
    BubbleGlow.Position = UDim2.new(0.5, 0, 0.5, 0)
    BubbleGlow.AnchorPoint = Vector2.new(0.5, 0.5)
    BubbleGlow.Image = "rbxassetid://4996891970"
    BubbleGlow.ImageColor3 = GuiConfig.Cores.Primaria
    BubbleGlow.ImageTransparency = 0.55
    BubbleGlow.ZIndex = 999
    BubbleGlow.InputTransparent = true
    ...
    PanelStroke.Color = GuiConfig.Cores.Borda
    ...
    Logo.BackgroundTransparency = 1
    Logo.Image = "rbxassetid://92760392968513"
    Logo.ScaleType = Enum.ScaleType.Fit
    Logo.ZIndex = 102
    ...
    Title.TextColor3 = GuiConfig.Cores.Texto
    ...
    Version.Size = UDim2.new(0, 120, 0, 18)
    Version.Position = UDim2.new(0, 50, 0, 28)
    ...
    MinimizeBtn.Position = UDim2.new(1, -96, 0.5, -14)
    ...
    ResizeBtn.Size = UDim2.fromOffset(28, 28)
    ResizeBtn.Position = UDim2.new(1, -62, 0.5, -14)
    ResizeBtn.BackgroundColor3 = Color3.fromRGB(70, 120, 70)
    ResizeBtn.Text = "+"
    ...
    CloseBtn.BackgroundColor3 = GuiConfig.Cores.Borda
    CloseBtn.Text = "X"
    ...
    TabList.Size = UDim2.new(0, 180, 1, 0)
    TabList.Position = UDim2.new(0, 0, 0, 0)
    TabList.BackgroundColor3 = Color3.fromRGB(14, 18, 28)
    ...
    TabPadding.Top = UDim.new(0, 10)
    TabPadding.Left = UDim.new(0, 5)
    TabPadding.Right = UDim.new(0, 5)
    TabPadding.Bottom = UDim.new(0, 10)

    TabLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
        TabList.CanvasSize = UDim2.fromOffset(0, TabLayout.AbsoluteContentSize.Y + 20)
    end)

    local TabContent = Instance.new("Frame")
    TabContent.Name = "TabContent"
    TabContent.Parent = Content
    TabContent.Size = UDim2.new(1, -190, 1, 0)
    TabContent.Position = UDim2.new(0, 190, 0, 0)
    TabContent.BackgroundColor3 = Color3.fromRGB(14, 18, 28)
    ...
    TabContentStroke.Color = GuiConfig.Cores.Primaria
    TabContentStroke.Thickness = 1
    TabContentStroke.Parent = TabContent
    ...
    local function CreateTab(name)
        ...
        TabFrameLayout.Padding = UDim.new(0, 6)
        ...
        TabFramePadding.Top = UDim.new(0, 10)
        TabFramePadding.Left = UDim.new(0, 8)
        TabFramePadding.Right = UDim.new(0, 8)
        TabFramePadding.Bottom = UDim.new(0, 10)

        TabFrameLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
            TabFrame.CanvasSize = UDim2.fromOffset(0, TabFrameLayout.AbsoluteContentSize.Y + 20)
        end)
        ...
        TabButton.MouseEnter:Connect(function()
            if CurrentTab ~= name then
                Tween(TabButton, 0.2, {BackgroundColor3 = Color3.fromRGB(40, 70, 120)})
            end
        end)

        TabButton.MouseLeave:Connect(function()
            if CurrentTab ~= name then
                Tween(TabButton, 0.2, {BackgroundColor3 = GuiConfig.Cores.AbaInativa})
            end
        end)
    ...
    MinimizeBtn.MouseButton1Click:Connect(function()
        ...
        Tween(MainPanel, 0.3, {Size = UDim2.fromOffset(GuiConfig.TamanhoAtual.Width, 50)})
    end)
    ...
    ResizeBtn.MouseButton1Click:Connect(function()
        if GuiConfig.Minimizado then
            GuiConfig.Minimizado = false
            Content.Visible = true
            Tween(MainPanel, 0.3, {Size = UDim2.fromOffset(GuiConfig.TamanhoAtual.Width, GuiConfig.TamanhoAtual.Height)})
        else
    ...
    CloseBtn.MouseButton1Click:Connect(function()
        ...
        Tween(MainPanel, 0.3, {Size = UDim2.fromOffset(0, 0)})
        task.wait(0.3)
        MainPanel.Visible = false
    end)
...
task.spawn(function()
    ...
    BubbleGlow.BackgroundTransparency = 1
    BubbleGlow.Image = "rbxassetid://92760392968513"
    BubbleGlow.ImageColor3 = GuiConfig.Cores.Primaria
